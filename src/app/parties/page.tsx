                                    ...
                                    <div>
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="flex flex-wrap gap-2 min-h-[32px]">
                                                {waiting.length > 0 ? waiting.map((member, index) => (<span key={index} className="bg-yellow-600 px-2 py-1 text-sm rounded">{member.email}</span>)) : <p className="text-sm text-gray-500">대기 멤버가 없습니다.</p>}
                                            </div>
                                        </div>
                                    </div>
